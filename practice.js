 ...
 */
 ...
 function last( Arr9, calBk) {
   return calBk( Arr9.slice (-1) [0])
 }
 ...
 */
 ...
 function multiply(number1,number2, calllB){
 
   return calllB(number1 * number2)
 }
 ...
 */
 ...
 function contains( array , name , callback) {
   ...
   for (i = 0; i < array.length ; i++ )
     if(array[i] === name ) {return callback(true)}
